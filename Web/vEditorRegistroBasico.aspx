<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vEditorRegistroBasico.aspx.cs" Culture="es-PE" UICulture="es-PE"
  Inherits="vEditorRegistroBasico" ValidateRequest="false" %>
...
<head runat="server">
  ...
  <title>Riesgos Generales | Registro Bsico Del Ajuste</title>
...
"- Mantenga pulsado el rat�ón en cualquiera de estos botones para una selección rápida.";
...
function doClean() {
    try {
        FTB_API['FormViewOcurrencia_txtInvestigaciones'].SetHtml(jQuery.htmlClean(FTB_API['FormViewOcurrencia_txtInvestigaciones'].GetHtml()));
    }
    catch (ex) {
  ...
  <form id="form1" runat="server">
    <div style="margin-left: auto; margin-right: auto; position: relative;">
      <div style="background-color: #3785B9; margin-bottom: 5px; height: 20px; position: relative;
        left: 0px; top: 0px;">
        <div style="position: absolute; left: 783px; width: 22px; top: 24px; height: 19px;
          cursor: pointer;">
      ...
      <div style="background-color: #3785B9; padding: 10px;">
        ...
        <div id="divDatosGenerales" class="collapsibleContent">
        ...
        <div style="margin-bottom: 5px;">
          <asp:Label Style="cursor: hand; cursor: pointer;" onclick="muestraOcultaDiv(this)"
            ID="Coordinacion" Font-Bold="True" Font-Size="16px" runat="server" Text="Fecha - Hora de Aviso & Coordinaci&oacute;n"></asp:Label>
        </div>
        <div id="divCoordinacion" class="collapsibleContent">
        ...
        <div id="divOcurrencia" class="collapsibleContent">
          <asp:FormView ID="FormViewOcurrencia" runat="server" DataSourceID="odsOcurrencia" OnDataBound="FormViewOcurrencia_DataBound"
            DefaultMode="Edit">
            <EditItemTemplate>
              <table border="0" cellpadding="0" cellspacing="0" class="DataTable">
                <tr>
                ...
                <tr>
                  ...
                  <td valign="top" style="width: 170px">
                    Investigaciones</td>
                  <td valign="top">
                      <FTB:FreeTextBox Visible="false"  SupportFolder="~/aspnet_client/FreeTextBox/" ScriptMode="External" ID="txtInvestigaciones" runat="server" AllowHtmlMode="False" AssemblyResourceHandlerPath=""
                          ...
                          DownLevelMessage="" DownLevelMode="TextArea" DownLevelRows="50" EditorBorderColorDark="Gray"
                          ...
                          HtmlModeCss="" HtmlModeCssClass="CssClassForTextBox" HtmlModeDefaultsToMonoSpaceFont="True"
                          ImageGalleryPath="~/images/" ImageGalleryUrl="ftb.imagegallery.aspx?rif={0}&cif={0}"
                          InstallationErrorMessage="InlineMessage" JavaScriptLocation="ExternalFile"
                          Language="es-ES" PasteMode="Default" ReadOnly="False" RemoveScriptNameFromBookmarks="True"
                          RemoveServerNameFromUrls="True" RenderMode="Rich" ShowTagPath="False"
                          SslUrl="/." StartMode="DesignMode" StripAllScripting="False" 
                          TabIndex="-1" TabMode="InsertSpaces" Text='<%# Bind("investigaciones") %>' TextDirection="LeftToRight"
        ...
        <div>
          <asp:Label Style="cursor: hand; cursor: pointer;" onclick="muestraOcultaDiv(this)"
            ID="Inspeccion" Font-Bold="True" Font-Size="16px" runat="server" Text="De La Inspecci&oacute;n"></asp:Label>
        </div>
        <div id="divInspeccion" class="collapsibleContent">
          <asp:FormView ID="FormViewInspeccion" runat="server" DataSourceID="odsInpeccion"
            DefaultMode="Edit" OnItemUpdating="FormViewInspeccion_ItemUpdating1">
            <EditItemTemplate>
              <table border="0" cellpadding="0" cellspacing="0" class="DataTable">
                <tr>
                  <td width="4">&nbsp;
        ...
        <div>
          <asp:LinkButton Font-Bold="True" Font-Size="16px" ID="LinkButton1" runat="server"
            OnClick="LinkButton1_Click">Detalle de los Subl&iacute;mites Afectados</asp:LinkButton>
        </div>
       <br />
        <div>
          <asp:LinkButton ID="LinkButton2" Font-Bold="True" Font-Size="16px" runat="server"
            OnClick="LinkButton2_Click">De La P&oacute;liza</asp:LinkButton></div>
			<br />
        <div>
          <asp:Label Style="cursor: hand; cursor: pointer;" onclick="muestraOcultaDiv(this)"
            ID="Reclamo" Font-Bold="True" Font-Size="16px" runat="server" Text="Del Reclamo"></asp:Label>
        </div>		
        <div id="divReclamo" class="collapsibleContent">
        ...
        <div>
          <asp:Label Style="cursor: hand; cursor: pointer;" onclick="muestraOcultaDiv(this)"
            ...
            Text="Informaci&oacute;n Complementaria">
          </asp:Label>
        </div>
                      ...
                      <tr>
                        ...
                        <td colspan="3" style="width: 270px">
                          ...
                          <asp:TextBox ID="txtReservaEstimada" runat="server" CssClass="FormText NUMBERS" Text='<%# Bind("Reserva") %>'
                            Width="195px"></asp:TextBox></td>
                        <td width="238">
                        <asp:Button ID="btnSeccionesAdicionales" runat="server" CssClass="FormText"
                            Text="Agregar Subt�tulos" Width="150px" OnClick="Button1_Click" />
                        <asp:ObjectDataSource ID="odsMoneda" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="GetData" TypeName="dsComboTableAdapters.MonedaComboTableAdapter"></asp:ObjectDataSource>
                        </td>
                      </tr>
        ...
        <br />
        <div>
            <asp:LinkButton ID="LnkDocumentosSolicitados" runat="server" Font-Bold="True"
                Font-Size="16px"  
                ToolTip="Permite dirigirse a la ventana de Solicitud de Documentos">Documentos Solicitados</asp:LinkButton></div>
        <br />
        <!-- fin seccion de divs collapsibles -->
      </div>
      <br />
      <div style="background-color: #3785B9; padding: 10px; height: 20px;">
        <asp:ImageButton ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" OnClientClick="doClean();" ImageUrl="~/imgRGen/btnSave.gif" />&nbsp;
