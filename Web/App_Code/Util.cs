...
namespace R3M.Common
{
  ...
  public class Util
  {
    ...
    internal static System.Collections.Generic.List<T1> GetArrayFromBag<T1>(System.Collections.IList iList)
    {
      int capacity = 0;
      if (iList != null)
      ...
      if (capacity > 0)
      {
        list.AddRange((IEnumerable<T1>)iList);
      }
      return list;
    }
    ...
    {
      DataTable dt = ((System.Data.DataTable)returnValue);
      if (dt != null)
