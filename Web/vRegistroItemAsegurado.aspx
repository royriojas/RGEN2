<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vRegistroItemAsegurado.aspx.cs"
  Inherits="vRegistroItemAsegurado" %>
...
<body style="background-image: none; background-color: #4C96C9;">
  <div style="margin-left: auto; margin-right: auto; position: relative; width: 701px;
    left: 0px; top: 0px;">
    <form id="formRegistroItemsAsegurados" runat="server">
      <div style="position: relative">
        <div id="ContenidoItemAsegurado" style="display: none;">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="DataTable">
            ...
            <tr>
              <td>
                &nbsp;</td>
              <td width="120" height="20" style="height: 23px">
              ...
              <td height="20" colspan="4">
                <span style="width: 314px">
                  <asp:TextBox ID="txtItemAsegurado" runat="server" CssClass="FormText" TextMode="MultiLine"
                    Width="454px" Height="70px"></asp:TextBox>
                </span>
              </td>
              <td>
                &nbsp;</td>
            ...
            <tr>
              ...
              <td style="height: 23px" width="120">
                Local</td>
              <td colspan="4" style="height: 20px">
                <asp:TextBox ID="txtLocal" runat="server" CssClass="FormText" Width="455px"></asp:TextBox></td>
              <td style="height: 20px">
              </td>
            </tr>
            <tr>
              ...
              <td style="height: 16px">
                <span style="width: 314px">
                  <asp:DropDownList ID="cbxConcepto1" runat="server" CssClass="FormSelect" Width="195px">
              ...
              <td style="height: 16px" colspan="2">
                <span style="width: 157px; color: #541c01; height: 14px">&nbsp;<asp:TextBox ID="txtMontoAsegurado"
                  runat="server" CssClass="FormText" Width="195px"></asp:TextBox></span></td>
              <td style="height: 16px">
              </td>
            </tr>
            <tr>
              ...
              <td style="height: 17px">
                <span style="width: 314px">
                  <asp:DropDownList ID="cbxConcepto2" runat="server" CssClass="FormSelect" Width="195px">
                    <asp:ListItem Value="Valor Declarado">Valor Declarado</asp:ListItem>
                    <asp:ListItem Value="Suma Asegurada">Suma Asegurada</asp:ListItem>
                    <asp:ListItem Value="L&#237;mite &#218;nico combinado">L&#237;mite &#218;nico combinado</asp:ListItem>
                    <asp:ListItem Value="Valor a Primer Riesgo">Valor a Primer Riesgo</asp:ListItem>
              ...
              <td style="height: 17px" colspan="2">
                <span style="width: 314px">&nbsp;<asp:TextBox ID="txtMontoAsegurado2" runat="server"
                  CssClass="FormText" Width="195px"></asp:TextBox></span></td>
              <td style="height: 17px">
              </td>
            </tr>
            <tr>
              ...
              <td style="height: 23px">
                &nbsp;</td>
              <td style="height: 17px">
                &nbsp;<asp:TextBox ID="txtMontoSoles" runat="server" BorderStyle="None" CssClass="FormText invisible"
                  Width="51px"></asp:TextBox>
                <asp:TextBox ID="txtMontoSoles2" runat="server" BorderStyle="None" CssClass="FormText invisible"
                  Width="51px"></asp:TextBox></td>
              <td style="height: 17px">
                &nbsp;</td>
              <td style="height: 17px">
                &nbsp;<asp:TextBox ID="txtTipoCambio" runat="server" CssClass="FormText invisible"
            ...
            <tr>
              ...
              <td style="height: 23px">
                &nbsp;</td>
              <td>
                <span style="height: 17px"><span style="width: 127px; height: 24px">
                  <asp:Button ID="btnAgregar" runat="server" CssClass="FormButton" Text="Agregar" OnClick="btnAgregar_Click" />
                </span></span>
              </td>
              <td>
                &nbsp;</td>
        ...
        <div style="height: 30px; margin-top: 5px; margin-bottom: 5px; position: relative;
          width: 701px; background-color: #4582bb;">
          &nbsp;&nbsp;
        ...
        <div id="ListaItemsAsegurados" style="margin-left: auto; margin-right: auto; position: relative">
          <div>
            <asp:GridView ID="gridItemsAsegurados" runat="server" AutoGenerateColumns="False"
              ...
              CssClass="DataTable" AllowPaging="True" OnRowDataBound="gridItemsAsegurados_RowDataBound"
              ...
              <Columns>
                ...
                <asp:TemplateField HeaderText="Visible">
                  <ItemTemplate>
                    ...
                    <asp:Label ID="lblItem" runat="server" Style="display: none;" Text='<%# Eval("itemAseguradosId") %>'></asp:Label>
                  </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                  <ItemTemplate>
              ...
              <EmptyDataTemplate>
                No hay Items asegurados
              </EmptyDataTemplate>
            </asp:GridView>
            <br />
            <asp:ImageButton ID="btnGuardar" runat="server" ImageUrl="~/imgRGen/btnSave.gif"
              OnClick="btnGuardar_Click" TabIndex="26" ToolTip="Insertar en el Ajuste" /></div>
        </div>
      </div>
    </form>
  </div>
  ...
  <asp:ObjectDataSource ID="odsItemsAsegurados" runat="server" DeleteMethod="Delete"
    InsertMethod="Insert" SelectMethod="GetData" TypeName="dsPolizaTableAdapters.ItemAseguradoPolizaAjusteTableAdapter"
    OnSelected="odsItemsAsegurados_Selected" OldValuesParameterFormatString="">
    <DeleteParameters>
  ...
  <asp:ObjectDataSource ID="odsInsertItemsAjuste" runat="server" InsertMethod="Insert"
    OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="dsPolizaTableAdapters.ItemAseguradoAjusteTableAdapter">
    <SelectParameters>
      <asp:QueryStringParameter Name="polizaId" QueryStringField="PolizaId" Type="Decimal" />
    </SelectParameters>
  </asp:ObjectDataSource>
