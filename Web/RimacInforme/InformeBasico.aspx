...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('a.GoDocuments').click(function() {
                showModalDialog('<%= this.ResolveClientUrl("~/vDocumentos.aspx?AjusteId=" + Request.QueryString["AjusteId"]) %>');
                return false;
            });
    ...
    <div class="InformeBasico InformeInner">
        ...
        <asp:FormView ID="FormViewInforme" DataKeyNames="AjusteId" Width="100%" runat="server"
            DefaultMode="Edit" 
            DataSourceID="odsInforme"             
            OnDataBound="FormViewInforme_DataBound" 
            OnItemUpdating="FormViewInforme_ItemUpdating"
            OnDataBinding="FormViewInforme_DataBinding">
            <EditItemTemplate>
                <div class="FormCSS">
                    ...
                    <div class="Group SituacionActual">
                        ...
                        <div class="Group-Content">
                            <div class="Field First TextEdit">
                                ...
                                <div class="FieldWrapper">
                                    <asp:TextBox Text='<%# Bind("SituacionSiniestro") %>' ID="_txtSituacionSiniestro" CssClass="FormText tinymce-simple" TextMode="MultiLine"
                                        runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div class="Field First">
                                ...
                                <div class="FieldWrapper">
                                    <div class="InlineElements">
                                        ...
                                        <asp:TextBox CssClass="FormText" Text='<%# Bind("Reclamo") %>' ID="_txtMontoAvisoReclamo" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="doClear">
                                </div>
                            ...
                            <div class="Field First">
                                ...
                                <div class="FieldWrapper">
                                    <div class="InlineElements">
                                        ...
                                        <asp:TextBox CssClass="FormText" Text='<%# Bind("Reserva") %>' ID="_txtReservaPreliminar" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="doClear">
                                </div>
                    ...
                    <div class="Group NotasFinales">
                        ...
                        <div class="Group-Content">
                            <div class="Field First">
                                ...
                                <div class="FieldWrapper">
                                    <asp:RadioButtonList ID="_radioListEnviarCopiaPoliza" SelectedValue='<%# Bind("EnviarCopiaPoliza") %>' CssClass="RadioList" RepeatLayout="Flow"
                            ...
                            <div class="Field ">
                                ...
                                <div class="FieldWrapper">
                                    <asp:RadioButtonList ID="_radioListEnviarFechaSiniestro" SelectedValue='<%# Bind("EnviaNumeroSiniestro") %>' CssClass="RadioList" RepeatLayout="Flow"
                            ...
                            <div class="Field TextEdit">
                                <label>
                                    Notas</label>
                                <div class="FieldWrapper">
                                    <asp:TextBox ID="_txtNotas" Text='<%# Bind("Notas") %>' CssClass="FormText tinymce-simple" TextMode="MultiLine"
                                        runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="doClear">
