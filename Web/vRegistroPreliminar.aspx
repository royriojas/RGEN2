<%@  Language="C#" AutoEventWireup="true" CodeFile="vRegistroPreliminar.aspx.cs" 
  Inherits="vRegistroPreliminar" Culture="es-PE" UICulture="es-PE" ValidateRequest="false" %>
...
<head id="Head1" runat="server">
  <title>Riesgos Generales | Registro Básico Del Ajuste</title>
  ...
  <form id="form1" runat="server">
    <div style="width: 855px; margin-left: auto; margin-right: auto; position: relative;
      ...
      <div style="background-color: #3785B9; padding: 10px;">
              ...
              <table width="765" border="0" cellpadding="0" cellspacing="0" class="DataTable">
                ...
                <tr>
                  ...
                  <td valign="top" style="width: 170px">
                    Investigaciones</td>
                  <td valign="top">
                      <FTB:FreeTextBox ID="txtInvestigaciones" runat="server" AllowHtmlMode="False" AssemblyResourceHandlerPath=""
                          ...
                          RemoveServerNameFromUrls="True" RenderMode="Rich" ScriptMode="External" ShowTagPath="False"
                      ...
                      <tr>
                        ...
                        <td colspan="3" style="width: 270px">
                          ...
                          <asp:TextBox ID="txtReservaEstimada" runat="server" CssClass="FormText NUMBERS" Text='<%# Bind("Reserva") %>'
                            Width="195px"></asp:TextBox></td>
                        <td width="238">
                          <asp:Button ID="Button1" runat="server" CssClass="FormText"
                            Text="Agregar Subtítulos" Width="150px" OnClick="Button1_Click" />
                          <asp:ObjectDataSource ID="odsMoneda" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="GetData" TypeName="dsComboTableAdapters.MonedaComboTableAdapter"></asp:ObjectDataSource>
                        </td>
                      </tr>
        ...
        <div>
            &nbsp;</div>
          <asp:LinkButton ID="LnkDocumentosSolicitados" runat="server" Font-Bold="True" Font-Size="16px"
              ToolTip="Permite dirigirse a la ventana de Solicitud de Documentos">Documentos Solicitados</asp:LinkButton><br />
