              ...
              <asp:TemplateField>
                ...
                <ItemTemplate>
                  <table border="0" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr>
                      <td>
                        <asp:ImageButton ID="ImageButton1" runat="server" CommandName="Eliminar" ImageUrl="~/imgRGen/deleteItem.gif" CommandArgument='<%# Eval("seccionId") %>' />
                      ...
                      <td align="right">
                        <asp:CheckBox ID="CheckBox2" runat="server" Checked='<%# Bind("visible") %>' Enabled="False"
                          Text="Visible" TextAlign="Left" /></td>
                    </tr>
                  </table>
                </ItemTemplate>
              </asp:TemplateField>
