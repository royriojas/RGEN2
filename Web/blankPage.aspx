...
<body>
    <form id="myform" runat="server">
        <div class="panelComments" style="position: relative;">
            <p class="Estilo1">
                ESTA PÁGINA NO ESTÁ DISPONIBLE</p>
            <p class="texto">
        ...
        <div class="panelComments" style="position: relative;">
            <p id='trg_gridContainer' class="texto">
                <strong>Haga Clic aquí para revisar las reglas de acceso definidas para un ajuste Normal.</strong></p>
            ...
            <p id='trg_gridContainerRapido' class="texto">
                <strong>Haga Clic aquí para revisar las reglas de acceso definidas para un ajuste Rápido.</strong></p>
